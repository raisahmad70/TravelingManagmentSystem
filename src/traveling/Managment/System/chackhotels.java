...
public class chackhotels  extends JFrame implements Runnable {
    Thread t1;
    ...
    chackhotels()
    {
        ...
        for (int i=0;i<10;i++) {
            ...
            ar[i] = new ImageIcon(ClassLoader.getSystemResource("icons/hotel"+(i+1)+".jpg"));
